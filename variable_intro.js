...
class VariableIntroSection extends React.Component {
	...
	{
		super(props);
		this.vi_null = this.vi_create_null();
		this.vi_dev = this.vi_create_dev();
		this.vi_it = this.vi_create_it();
		this.vi_qa = this.vi_create_qa();
		this.vi_anal = this.vi_create_anal();
		this.vi_db = this.vi_create_db();
		this.state = {
			intro: this.vi_null
		};
